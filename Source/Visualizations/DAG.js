...
/*
  ...
  All <Loader> methods
   ...
   op - Access a <DAG.Op> instance.
   fx - Access a <DAG.Plot> instance.
   labels - Access a <DAG.Label> interface implementation.   
*/

$jit.DAG = new Class( {

  Implements: [
      Loader, Extras, Layouts.DAG
  ],
  ...
  initialize: function(controller){
    ...
    this.graph = new Graph(this.graphOptions, this.config.Node,
        this.config.Edge);
    this.labels = new $DAG.Label[canvasConfig.Label.type](this);
    this.fx = new $DAG.Plot(this, $DAG);
    this.op = new $DAG.Op(this);
    this.json = null;
    this.root = null;
    this.busy = false;
    this.parent = false;
  ...
  /*
   ...
   Plots the DAG. This is a shortcut to *fx.plot*.
  */
  plot: function(){
    this.fx.plot();
  },
  ...
  */
  ...
  Animates the <DAG> to center the node specified by *id*.
